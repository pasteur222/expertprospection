      ...
      topics: [
        {
          ...
          content: `
L'assistant éducatif utilise l'IA pour :
1. Analyser les questions des étudiants
2. Identifier la matière et le sujet
3. Évaluer le niveau de compréhension
4. Fournir des explications adaptées
5. Proposer des exercices pratiques
6. Suivre la progression de l'étudiant

Les étudiants peuvent poser des questions dans toutes les matières via WhatsApp.
          `
        },
        {
